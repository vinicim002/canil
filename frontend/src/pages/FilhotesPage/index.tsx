    ...
    <main className="filhotes-page pt-32 pb-20 bg-cream/20">
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12 flex flex-col gap-20">
        ...
        <header className="filhotes-header flex flex-col items-center justify-center gap-10 text-center">
          <motion.div {...fadeInUp} className="filhotes-header-texto flex flex-col gap-4">
            <h3 className="font-black tracking-[0.4em] text-orange text-sm md:text-base uppercase">
              Disponíveis Agora
            </h3>
            <h1 className="font-cmas-play text-brown text-5xl md:text-7xl font-bold uppercase">Filhotes</h1>
        ...
        <section className="filhotes-categoria flex flex-col gap-10">
          <motion.div {...fadeInUp} className="filhotes-categoria-header flex flex-col md:flex-row md:items-center gap-6">
            <div className="flex flex-col gap-2">
              <div className="flex flex-row items-center gap-4">
                <h2 className="font-cmas-play text-brown text-4xl font-bold uppercase">Machos</h2>
          ...
          >
            ...
            <motion.div variants={item} className="filhote-card group flex flex-col gap-4">
        ...
        <section className="filhotes-categoria flex flex-col gap-10">
          <motion.div {...fadeInUp} className="filhotes-categoria-header flex flex-col md:flex-row md:items-center gap-6">
            <div className="flex flex-col gap-2">
              <div className="flex flex-row items-center gap-4">
                <h2 className="font-cmas-play text-brown text-4xl font-bold uppercase">Femeas</h2>
                <span className="bg-brown text-white text-[10px] font-black py-1 px-3 rounded-full uppercase tracking-tighter">
                  3 disponíveis
                </span>
              </div>
