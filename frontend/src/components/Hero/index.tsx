...
export function Hero() {
  return (
    <>
      <div className="hero relative bg-cream flex items-center justify-center flex-col h-screen overflow-hidden">
        <div className="info-geral flex flex-col items-center gap-8 justify-center z-10">
          ...
          <button className="bg-amber-950 text-amber-50 p-3 rounded-full cursor-pointer">
            VER FILHOTES DISPONIVEIS
          </button>
        </div>
        ...
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2">
          ...
          <img
            ...
            alt=""
          />
          <img src={dogImg} className="relative z-10" alt="" />
        </div>
      </div>
    </>
  );
